...
type SyncService interface {
  ...
  // Parameters:
  //  - Md5
  CheckDataDigest(ctx context.Context, md5 string) (r *SyncStatus, err error)
...
// Parameters:
//  - Md5
func (p *SyncServiceClient) CheckDataDigest(ctx context.Context, md5 string) (r *SyncStatus, err error) {
  var _args12 SyncServiceCheckDataDigestArgs
  _args12.Md5 = md5
  var _result13 SyncServiceCheckDataDigestResult
  if err = p.Client_().Call(ctx, "checkDataDigest", &_args12, &_result13); err != nil {
    return
  }
...
func NewSyncServiceProcessor(handler SyncService) *SyncServiceProcessor {
  ...
  self16.processorMap["checkDataDigest"] = &syncServiceProcessorCheckDataDigest{handler:handler}
...
func (p *syncServiceProcessorCheckDataDigest) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
  ...
  if err = args.Read(iprot); err != nil {
    iprot.ReadMessageEnd()
    x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
    oprot.WriteMessageBegin("checkDataDigest", thrift.EXCEPTION, seqId)
    x.Write(oprot)
    oprot.WriteMessageEnd()
    oprot.Flush(ctx)
    return false, err
...
var retval *SyncStatus
  ...
  if err2 = oprot.WriteMessageBegin("checkDataDigest", thrift.REPLY, seqId); err2 != nil {
    err = err2
  }
  if err2 = result.Write(oprot); err == nil && err2 != nil {
    err = err2
...
func (p *SyncServiceCheckDataDigestArgs) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *SyncServiceCheckDataDigestArgs)  ReadField1(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
  return thrift.PrependError("error reading field 1: ", err)
} else {
  p.Md5 = v
...
func (p *SyncServiceCheckDataDigestArgs) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("checkDataDigest_args"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField1(oprot); err != nil { return err }
  }
...
func (p *SyncServiceCheckDataDigestArgs) writeField1(oprot thrift.TProtocol) (err error) {
...
func (p *SyncServiceCheckDataDigestResult) Read(iprot thrift.TProtocol) error {
  if _, err := iprot.ReadStructBegin(); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T read error: ", p), err)
  }
...
func (p *SyncServiceCheckDataDigestResult)  ReadField0(iprot thrift.TProtocol) error {
  p.Success = &SyncStatus{}
  if err := p.Success.Read(iprot); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T error reading struct: ", p.Success), err)
  }
...
func (p *SyncServiceCheckDataDigestResult) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("checkDataDigest_result"); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write struct begin error: ", p), err) }
  if p != nil {
    if err := p.writeField0(oprot); err != nil { return err }
  }
...
func (p *SyncServiceCheckDataDigestResult) writeField0(oprot thrift.TProtocol) (err error) {
  if p.IsSetSuccess() {
    if err := oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
      return thrift.PrependError(fmt.Sprintf("%T write field begin error 0:success: ", p), err) }
    if err := p.Success.Write(oprot); err != nil {
